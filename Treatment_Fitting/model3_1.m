...
% Numerically fits Model 3.1 with drug-induced acquired resistanc but   %
% no pre-existing resistance to each treatment mouse (using censored    %
...
parfor m = 1:num_mice
    ...
    for rep = 1:numreps
        ...
        % fprintf("Mouse %d rep %d n_skip is %d\n",m,rep,n_skip);
        n_leap = 0;
