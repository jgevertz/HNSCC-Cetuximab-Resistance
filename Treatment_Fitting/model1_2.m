...
% Numerically fits Model 1.2 with pre-existing but not acquired         %
...
Best_g = zeros(num_mice,numreps + 1); Best_lambda_s = zeros(num_mice,numreps + 1);
gamma = log(0.5)/-4.75;
Best_lambda_r = zeros(num_mice,numreps + 1); Best_SSE = zeros(num_mice,numreps + 1);
Best_y0 = zeros(num_mice,numreps + 1); Best_y0r = zeros(num_mice,numreps + 1);
