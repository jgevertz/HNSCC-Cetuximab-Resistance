...
% Numerically fits Model 2.2 with both pre-existing and randomly        %
...
parfor m = 1:num_mice
    ...
    for rep = 1:numreps
        ...
        for u = 1:n_Sbpts % n_pts  % Solve DE at all biologically-relevant Sobol points
            if ((uniform_sobol_scaled(u,4) > uniform_sobol_scaled(u,5))...
                    &&(uniform_sobol_scaled(u,1)>=uniform_sobol_scaled(u,2)))
