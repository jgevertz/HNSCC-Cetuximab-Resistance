...
% Numerically fits Model 2.1 with randomly acquired resistanc but no    %
% pre-existing resistance to each treatment mouse (using censored       %
...
Final_r_s = Best_r_s(:,numreps + 1)'; Final_r_r = Best_r_r(:,numreps + 1)';
Final_g = Best_g(:,numreps + 1)';
Final_lambda_s = Best_lambda_s(:,numreps + 1)';
Final_lambda_r = Best_lambda_r(:,numreps + 1)';
Final_SSE = Best_SSE(:,numreps + 1)';
Final_y0 = Best_y0(:,numreps + 1)'; Final_y0r = Best_y0r(:,numreps + 1)';
